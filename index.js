...
$('.btn').click((err) => {
  ...
  if (button.html() == 'English') {
    ...
    listTwo.html('<li>Customer Service</li><li>Operational assistance</li><li>Querying customer data and processes</li>');
